...
import { DashbMatchesDialogComponent } from '@pages/dashboard/dashb-matches/dashb-matches-dialog/dashb-matches-dialog.component';
import { DashbMatchesComponent } from '@pages/dashboard/dashb-matches/dashb-matches.component';
...
@NgModule({
  declarations: [
    ...
    DashbMatchesDialogComponent,
    DashbMatchesComponent,
